...
const Features = () => {
  return (
    <Container className="features-page-wrapper">
      <Row className="features-page-wrapper-row">
        <Col lg={5} md={5} sm={12} className="p-3">
          <Row>
            ...
            <Col xs={12}>
              <Row className="feature-page-image-wrapper">
        ...
        <Col lg={7} md={7} sm={12}>
          <Row className="p-4 feature-page-details">
