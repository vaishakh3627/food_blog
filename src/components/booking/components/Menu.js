...
import { BURGER, SNACK, BEVERAGE } from "../../../common/Constants/constants";
    ...
    <Col lg={7} md={7} sm={12}>
      {BurgerMenu.map((item, key) => (
        <Row key={key} className="mb-3">
          <Col lg={2} md={2} sm={2} className="p-2 booking-menu-image-wrapper">
...
const Menu = () => {
  ...
  return (
    <Container fluid className="booking-menu-wrapper mb-5">
      <Row>
